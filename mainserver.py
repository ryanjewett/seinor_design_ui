...
@app.route('/help')
def help_user():
    return "API: /storageleft, /store/mode/date/time/, /ret/mode/date/time, /kill"
...
@app.route('/getchk/<mode>/<date1>/<date2>')
